                ...
                <table class = "table table-bordered">
                    ...
                    @foreach($stations as $station)
                        <tr data-id = "{{$station->id}}">
                            <td>{{ $count++ }}</td>
                            <td>{!! Form::text('station_name', $station->station_name, ['class' => 'form-control']) !!}</td>
                            <td>{!! Form::text('station_description', $station->station_description, ['class' => 'form-control']) !!}</td>
                            <td>
