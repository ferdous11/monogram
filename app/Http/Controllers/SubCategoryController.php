...
class SubCategoryController extends Controller
{
	...
	public function store (Request $request)
	{
		...
		$sub_category->sub_category_display_order = $request->get('sub_category_display_order');
	...
	public function update (Request $request, $id)
	{
		...
		$subcategory->sub_category_display_order = $request->get('sub_category_display_order');
